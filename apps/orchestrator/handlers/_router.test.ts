...
describe('matchRoute — happy-path resolution', () => {
	const cases: Array<[string, string, string]> = [
		...
		['POST', '/api/auth/yjs-token', 'auth/yjs-token'],
		...
		['GET', '/api/workspaces/ws_1/share-links', 'workspaces/share-links'],
		['POST', '/api/workspaces/ws_1/share-links', 'workspaces/share-links'],
		['DELETE', '/api/workspaces/ws_1/share-links/shl_2', 'workspaces/share-links'],
